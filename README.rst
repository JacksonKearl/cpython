...
The original CPython starts up in 50ms on my computer, but after subbed to use even this most simple implementation of ``malloc``, the resultant Python requires only 20ms for startup.
